...
def value_of_ace(card_one, card_two):
    ...
    card_sum = value_of_hand(card_one, card_two)
...
def is_blackjack(card_one, card_two):
    ...
    ace = has_ace(card_one, card_two)
    ten = 10 in (value_of_card(card_one), value_of_card(card_two))
...
def can_double_down(card_one, card_two):
    ...
    return card_sum in double_down