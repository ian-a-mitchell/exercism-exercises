""" Set of methods and objects to support generating an arbitrary subset of
the verses for the song "I Know an Old Lady Who Swallowed a Fly".
"""
...
def verse_builder(verse_num: int) -> list[str]:
    ...
    Swallowed A Fly". Proceeds iteratively, building up the song line-by-line
    based on the current verse number.
