"""
A solution to the Go Counting exercise from Exercism. Largely copied from a
community solution due to being unable to think of a way to tackle this.
"""
...
class Board:
    ...
    def on_board(self, row_idx: int, col_idx: int) -> bool:
        ...
        valid_row = 0 <= row_idx < len(self.board)
        
        return valid_row and 0 <= col_idx < len(self.board[row_idx])
