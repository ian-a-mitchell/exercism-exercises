...
class LedgerEntry:
    ...
    def format_change(self,
        ...
        formatted_change = f"{formatted_change:{pad}>{change_width}}"
    ...
    def format_entry(self, 
        ...
        line.append(self.format_date(locale))
        line.append(spacer)
            
        line.append(self.format_description(description_width, pad))
        line.append(spacer)
        
        line.append(self.format_change(currency, locale, change_width, pad))
