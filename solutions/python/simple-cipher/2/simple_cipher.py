...
class Cipher:
    ...
    def _keygen() -> str:
        ...
        key = [secrets.choice(letters) for _ in range(Cipher._KEY_LEN)]
    ...
    def __init__(self, key=None) -> None:
        ...
        if not key or any(char not in letters for char in key):
    ...
    def encode(self, text: str) -> str:
        ...
        output = [letters[(letters.index(char) + letters.index(key_char)) 
                          % len(letters)]
