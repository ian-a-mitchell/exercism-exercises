...
def compare_records(azara_record, rui_record):
    ...
    return convert_coordinate(get_coordinate(azara_record)) == rui_record[-2]
...
def clean_up_record(comb_record):
    ...
    return str(tuple((comb_record[0],) + comb_record[2:])) + '\n'
...
def clean_up(combined_record_group):
    ...
    return ''.join(tuple(map(clean_up_record, combined_record_group)))
