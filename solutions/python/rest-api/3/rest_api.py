...
class User:
    ...
    def __init__(self, 
                 ...
                 **kwargs):
        """ 
        Sets up the user object. The **kwargs argument is necessary since the
        input provides a balance quantity that is not used here.
        ...
        self._name = name
        self._records = {}
        for debtor, amount in owed_by.items():
            self.loan(debtor, amount)
        for creditor, amount in owes.items():
