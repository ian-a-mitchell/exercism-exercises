...
class RestAPI:
    ...
    @staticmethod
    def _change_user_balance(user: dict, 
                             counterparty: str, 
                             amount: float) -> dict:
        """
    ...
    def _change_balance(self, payload: str) -> dict:
        ...
        for user in self._database[RestAPI._USERS]:
            if user[RestAPI._NAME] == lender:
                lender_entry = RestAPI._change_user_balance(user, borrower, amount)
            elif user[RestAPI._NAME] == borrower:
                borrower_entry = RestAPI._change_user_balance(user, lender, -amount)
